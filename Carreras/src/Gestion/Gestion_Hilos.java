...
public class Gestion_Hilos {
	 ...
	 private Game game = new Game(); 
		...
		public void Player() {
			...
			Thread player_three = new Thread(new Crear_Jugador(Game.img_dado_1_p3, Game.img_dado_2_p3, Game.lbl_suma_res_p3, Game.lbl_suma_res_pa_p3,
					segundos,numone,numtwo,contadorp3,Game.lbl_Car_3,game));
			
			Thread player_four = new Thread(new Crear_Jugador(Game.img_dado_1_p4, Game.img_dado_2_p4, Game.lbl_suma_res_p4, Game.lbl_suma_res_pa_p4,
					segundos,numone,numtwo,contadorp4,Game.lbl_Car_4,game));
			
			Thread player_Five = new Thread(new Crear_Jugador(Game.img_dado_1_p5, Game.img_dado_2_p5, Game.lbl_suma_res_p5, Game.lbl_suma_res_pa_p5,
					segundos,numone,numtwo,contadorp5,Game.lbl_Car_5,game));
