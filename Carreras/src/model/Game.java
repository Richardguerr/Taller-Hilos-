...
public class Game extends JFrame {
	...
	public Game() {
		...
		lbl_p1_p.setBounds(158, 342, 163, 43);
		...
		lbl_Car_1 = new JLabel("Player_One");
		lbl_Car_1.setFont(new Font("Comic Sans MS", Font.BOLD | Font.ITALIC, 17));
		lbl_Car_1.setHorizontalTextPosition(SwingConstants.CENTER);
		lbl_Car_1.setVerticalAlignment(SwingConstants.TOP);
		lbl_Car_1.setVerticalTextPosition(SwingConstants.BOTTOM);
		lbl_Car_1.setIcon(new ImageIcon(Game.class.getResource("/imagenes/carro_1.png")));
		lbl_Car_1.setBounds(24, 11, 209, 132);
		panel_carrera.add(lbl_Car_1);
		
		lbl_Car_2 = new JLabel("Player_Two");
		lbl_Car_2.setFont(new Font("Comic Sans MS", Font.BOLD | Font.ITALIC, 17));
		lbl_Car_2.setHorizontalTextPosition(SwingConstants.CENTER);
		lbl_Car_2.setVerticalTextPosition(SwingConstants.BOTTOM);
		lbl_Car_2.setIcon(new ImageIcon(Game.class.getResource("/imagenes/carro_2.png")));
		lbl_Car_2.setBounds(24, 154, 209, 125);
